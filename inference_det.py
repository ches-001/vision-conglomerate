...
def evaluate_frames(
    ...
    with torch.no_grad():
        if isinstance(dataset, SingleImgSample):
            ...
            preds = model(touched_img, inference=True, og_size=og_img.shape[1:])
            ...
            vwriter = None
            start_idx = 0
            for touched_img_batch, og_img_batch in tqdm.tqdm(dataset):
...
if __name__ == "__main__":
    ...
    best_model_path = f"saved_model/detection/best_model/{DetectionNet.__name__}.pth.tar"
